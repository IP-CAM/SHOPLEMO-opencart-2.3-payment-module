...
class ControllerExtensionPaymentShoplemo extends Controller
{
    ...
    public function index()
    {
        ...
        $data['formActionUrl'] = $this->getSiteUrl() . 'index.php?route=extension/payment/shoplemo&token=' . $this->session->data['token'];
        $data['formCancelUrl'] = $this->getSiteUrl() . 'index.php?route=marketplace/extension&token=' . $this->session->data['token'];
